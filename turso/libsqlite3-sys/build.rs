...
fn main() {
    ...
    println!("cargo:rerun-if-changed={BUNDLED_DIR}/bindings/bindgen.rs");
    println!("cargo:rerun-if-changed={BUNDLED_DIR}/bindings/session_bindgen.rs");
